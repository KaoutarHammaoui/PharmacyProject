...
class AdminnController extends Controller
{
    public function getMeds(){
        ...
        return view('admin.medsInfos', compact('products'));
    }

    public function getMed($id)
    {
        $product = Product::with('stocks', 'equivalents')->findOrFail($id);
        return view('admin.medInfos', compact('product'));
    }

    public function showAddMed()
    {
        $products = Product::all();
        return view('admin.addMed', compact('products'));
    }
    ...
    public function editMed($id)
    {
        ...
        return view('admin.updateMed', compact('product', 'allProducts', 'currentEquivalentIds'));
    }
    ...
    public function medsShortage()
    {
        ...
        $shortageProducts = $allProducts->filter(function ($product) {
            ...
            $effectiveQuantity = $product->total_quantity;
            return [$effectiveQuantity, $product->name];
        });

        return view('admin.medsShortage', compact('shortageProducts'));
    }
