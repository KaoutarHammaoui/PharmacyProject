                ...
                <div x-show="open"
                    ...
                    <ul class="space-y-1">
                        ...
                        <a href="{{ route('medsInfosp') }}"
                               class="flex items-center w-full px-4 py-2 rounded bg-gray-800 hover:bg-gray-700 {{ request()->routeIs('medsInfosp') ? 'bg-gray-700 font-semibold' : '' }}">
                                Medicaments
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('medsShortagep') }}"
                               class="flex items-center w-full px-4 py-2 rounded bg-gray-800 hover:bg-gray-700 {{ request()->routeIs('medsShortagep') ? 'bg-gray-700 font-semibold' : '' }}">
                               Pénurie
                            </a>
                        </li>
                    </ul>
