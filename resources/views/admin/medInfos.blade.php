        ...
        <div class="flex-1 p-6 mt-[50px]">
            <div class="max-w-4xl mx-auto space-y-4">
                <div class="bg-white rounded-lg shadow-sm border p-6">
                    ...
                    <div class="grid grid-cols-4 gap-8">
                        ...
                        <div>
                            ...
                            <div class="text-sm text-gray-500">Avec Ordonnance</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-sm border p-6">
                    ...
                    <div class="grid grid-cols-4 gap-8">
                        <div>
                            <div class="text-2xl font-bold text-gray-800">{{ $product->stocks->sum('quantite') ?? 'N/A' }}</div>
                        ...
                        <div>
                            <div class="text-2xl font-bold text-gray-800">{{ optional($product->stocks->first())->date_expiration ?? 'N/A' }}</div>
